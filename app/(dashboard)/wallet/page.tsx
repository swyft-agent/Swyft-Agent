...
import { Wallet, Plus, ArrowUpRight, ArrowDownLeft, CreditCard, Smartphone } from "lucide-react"
...
interface Transaction {
  id: string
  type: "deposit" | "withdrawal" | "payment_received" | "payment_sent"
  amount: number
  description: string
    ...
    <div className="space-y-6 bg-white min-h-screen p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(walletData.total_received)}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(walletData.total_sent)}</div>
          </CardContent>
        </Card>
      </div>
                ...
                <div key={transaction.id} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {transaction.reference && <p className="text-xs text-gray-400">Ref: {transaction.reference}</p>}
                    </div>
                  </div>
